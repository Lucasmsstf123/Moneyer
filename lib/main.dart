    ...
    void addpcost() { //##############################################################
      setState(() {
        showDialog(context: context,
          builder: (context){
            return AlertDialog(
              title: Text("Nova Categoria de Gasto:"),
              content: 
                  TextField(
                    decoration: const InputDecoration(
                      border: UnderlineInputBorder(),
              ...
              actions: [
                ...
                ElevatedButton(onPressed: (){
                  Navigator.of(context).pop();
                  setState(() {
                    final gasto = Gastos(nameControl.text.toString(), 0, 1, []);
...
void expensesResults(Gastos gasto){
  gasto.value = 0;
    for (var i = 0; i < gasto.quantExpenses; i++) {
            ...
            return AlertDialog(
              ...
              actions: [
                ...
                ElevatedButton(onPressed: (){
                  Navigator.of(context).pop();
                  setState(() {
                    final expense = DescExpenses(descriptionControl.text.toString(), double.parse(expenseControl.text.toString()));
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => SettingsPage(pgastos: pgastosList, bgastos: bgastosList,)));
                },
              ...
              Container(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    if (index == 0) {//EXEMPLOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
                      return ListTile(
                          title: Text("Categorias Pessoais",
                          style: txtstyle,),
                          subtitle: Text("R\$ Valor dos gastos",
                          style: txtstyle,),
                          trailing: IconButton(
                        onPressed: () { setState(() {
                    ...
                    else{//REAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAALLLLLLLLLLLL FUNCIONAAAAAAAAAAAAAAAAAAAALLLLLLLLLLLLLLL
                      return ListTile(
                      leading: IconButton(
                          onPressed: () {editGasto(pgastosList[index-1]);},
                          icon: const Icon(
                            Icons.edit,
                            color: Colors.grey,
                          )),
                      title: Text(pgastosList[index-1].name,
                        style: txtstyle,
                      ),
                      subtitle: Text("R\$ ${pgastosList[index-1].value}",
                        style: txtstyle,
                      ),
                      trailing: IconButton(
                        onPressed: (){addPexpense(pgastosList[index-1]);},
                        icon: const Icon(
                          Icons.add,
                          color: Colors.green,
                        ),
                      ...
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PessoalPage(gasto: pgastosList[index-1],)));
                      },
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    if (index == 0) {//EXEMPLOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
                      ...
                      return ListTile(
                      leading: IconButton(
                          onPressed: () {editGasto(bgastosList[index-1]);},
                          icon: const Icon(
                            Icons.edit,
                            color: Colors.grey,
                          )),
                      title: Text(bgastosList[index-1].name,
                        style: txtstyle,
                      ),
                      subtitle: Text("R\$ ${bgastosList[index-1].value}",
                        style: txtstyle,
                      ),
                      trailing: IconButton(
                        onPressed: (){addBexpense(bgastosList[index-1]);},
                        icon: const Icon(
                          Icons.add,
                          color: Colors.green,
                        ),
                      ...
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => PessoalPage(gasto: bgastosList[index-1],)));
                      },
                    );//FIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIMMMMMMMMMMMMMMMMMMMM
                    }
                  },
